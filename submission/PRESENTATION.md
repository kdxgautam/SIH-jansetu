...
- **PDF (submit this one):** [JanSetu_SIH2026_Presentation.pdf](./JanSetu_SIH2026_Presentation.pdf)
- **PPTX (editable source):** [JanSetu_SIH2026_Presentation.pptx](./JanSetu_SIH2026_Presentation.pptx)
...
It writes `submission/JanSetu_SIH2026_Presentation.pptx`. Export a fresh PDF
from that file before submitting.

## Before submission

- [ ] Fill the Team ID and Team Name on slide 1 with the values registered on
      the SIH portal. Do not guess these.
